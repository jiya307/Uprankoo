...
export default function Footer() {
  ...
  color: '#166534',
        ...
        {/* Divider */}
        <div style={{ height: 1, background: 'rgba(0,0,0,0.08)', marginBottom: '1.5rem' }} />

        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 text-xs" style={{ color: 'rgba(0,0,0,1)' }}>
