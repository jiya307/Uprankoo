...
export default function LeadForm() {
  ...
  const inputClass =
    `w-full border rounded-xl px-4 py-3.5 placeholder-black/30
                  ...
                  <div className="grid sm:grid-cols-2 gap-5">
                    <div className="relative">
                      ...
                      <input type="text" name="name" value={form.name} onChange={handleChange}
                        placeholder="Your Name" required className={`${inputClass} pl-10`} />
                    </div>
                    <div className="relative">
                      ...
                      <input type="text" name="business_name" value={form.business_name} onChange={handleChange}
                        placeholder="Business Name" required className={`${inputClass} pl-10`} />
                    </div>
                  </div>
                  ...
                  <div className="grid sm:grid-cols-2 gap-5">
                    <div className="relative">
                      ...
                      <input type="tel" name="phone" value={form.phone} onChange={handleChange}
                        placeholder="Phone Number" required className={`${inputClass} pl-10`} />
                    </div>
