...
import { loginWithFacebook } from '../auth/FacebookLogin';
...
export default function LoginPage() {
  ...
  async function handleFacebookLogin() {
    setError(''); setSocialLoading('facebook');
    try {
          ...
          <div ref={cardRef} className="bg-white rounded-3xl shadow-xl border border-neutral-100 p-8 lg:p-12">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button type="button" onClick={handleGoogleLogin} disabled={socialLoading !== null}
                className="w-full py-3.5 rounded-xl border border-neutral-200 bg-white font-medium text-neutral-700 flex items-center justify-center gap-3 hover:bg-neutral-50 transition disabled:opacity-60">
              ...
              <button type="button" onClick={handleFacebookLogin} disabled={socialLoading !== null}
                className="w-full py-3.5 rounded-xl border border-neutral-200 bg-white font-medium text-neutral-700 flex items-center justify-center gap-3 hover:bg-neutral-50 transition disabled:opacity-60">
