...
const TOOLS = [
  {
    ...
    url: import.meta.env.VITE_PLATFORM_ADMIN_URL,
    icon: ShieldCheck,
  },
  {
    title: 'Files Manager',
    ...
    url: import.meta.env.VITE_FILES_MANAGER_URL,
    icon: FolderCog,
  },
];
...
export default function OwnerAdminPage() {
  return (
    <DashboardLayout>
      ...
      <div className="mb-8">
        <h1 className="text-black font-black text-2xl mb-1">
          Owner Admin Panel
        </h1>
        ...
        <p
          ...
          style={{ color: 'black' }}
        >
          Quick access to external administration tools
        </p>
      </div>
